(()=>{
  ...
  function valuePair(def,list,home,away){
    ...
    if(key.startsWith('carries_custom')||key.includes('carrying_distance_custom')||key.includes('progressive_carries_custom')){}const hc=key.includes('carr')?carrySummary(list,home):null,ac=key.includes('carr')?carrySummary(list,away):null;
